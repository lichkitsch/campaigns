...
You start with `10+CON` HP at level 1. If your own HP falls to zero, you suffer a dire consequence. While resting with food and sleep, roll your damage dice to heal HP. When you level up, roll your new damage dice and add the result to your max HP. You can reroll `CON` dice when leveling up.
